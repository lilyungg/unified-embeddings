...
Historic files:
  historic_movielens.json              — MovieLens-1M, full-rank DCN, 10 epochs
  historic_avazu_fullrank_dcn.json     — Avazu 1M, full-rank DCN (overfit), 10 epochs
  historic_criteo_fullrank_dcn.json    — Criteo 1M, full-rank DCN (overfit), 10 epochs
